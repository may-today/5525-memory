 ...
 */
export function SharePoster({ nickname, passcode, shows, signatureSong }: SharePosterProps) {
  ...
  return (
    <div className="share-poster-in relative mx-auto flex aspect-[5/7] w-full max-w-sm flex-col overflow-hidden rounded-2xl border border-zinc-800 bg-zinc-950 text-zinc-100">
